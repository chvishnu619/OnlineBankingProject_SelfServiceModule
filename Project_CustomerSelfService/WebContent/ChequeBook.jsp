...
<form action='SubmitCheque' method="post">
...
<tr>
<td><span style='color:red'>*</span>No of Cheque Leaves:</td>
<td><label>
    <input type="radio" name="leaves" value="20" required>
    20
  </label>

  <label>
    <input type="radio" name="leaves" value="50">
    50
  </label>

  <label>
    <input type="radio" name="leaves" value="100">
    100
  </label>
</td>
</tr>
